...
- [ ] Poursuite démarrage du KMO-Predict
    ...
    - [ ] Résolution du passage des tests autogénérés
        - [ ] Front-end
            - [ ] Résolution de home-cop.component.spec.ts avec erreur :
            ```
            ...
            ```
            - [ ] Résolution de cop.component.spec.ts avec erreur :
            ```
            ...
            ```
            - [ ] Résolution de checkout-modal.component.spec.ts avec erreur :
            ```
            ...
            ```
                ...
                NG0304: 'mat-nav-list' is not a known element (used in the 'AppComponent' component template):
                ```
            - [ ] Résolution de store.component.spec.ts avec erreur :
            ```
