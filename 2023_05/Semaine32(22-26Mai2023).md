        ...
        - [ ] Passe controllers
            - [ ] fichier stores.controller.ts
                - [ ] getAll
                    ...
                    - [ ] Résolution du fail : Nest can't resolve dependencies of the StoresService (?). Please make sure that the argument StoreRepository at index [0] is available in the RootTestModule context
                - [ ] create
                - [ ] findAll
                - [ ] findStoreWithData
                - [ ] updateStore
